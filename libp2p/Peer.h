...
public:
    ...
    void setCapabilityOffset(CapDesc const& _cap, unsigned _offset) { m_capabilityOffsets[_cap] = _offset; }
//    void setCapabilityVersion(CapDesc const& _cap, u256 const _version) { m_capabilityVersions[_cap] = _version; }
